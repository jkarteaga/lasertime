    ...
    return (
        <div>
            ...
            <p>Медицинский центр «Знак качества» предлагает консультацию врача и индивидуальный комплексный подход к
                ...
                препаратов,
                нацеленных на решение конкретной проблемы. Наши врачи, устраняя имеющиеся у пациента проблемы,
                используют
                наиболее щадящие, безболезненные и эффективные методики, а также стремятся задействовать превентивные
                меры
                для устранения проблем, возникающих в будущем.</p>
            ...
            <p>Эффективность работы медицинского центра «Знак качества» определяется нацеленностью на результат, что в
                свою
                очередь достигается тремя основополагающими принципами работы центра:</p>
            <ul>
            ...
            <p>Наилучший результат обеспечивается комплексным подходом к решению конкретной проблемы. Так, использование
                ...
                другими
                аппаратными и инъекционными методиками обеспечивает решение многих проблем.</p>
