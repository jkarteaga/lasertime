            ...
            <div className="Action__body">
                ...
                <div className={`Action__deadline Action__deadline--${deadlineColor}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
                            d="M470 124.8L371.6 43l-28 33 98.6 81.8 27.8-33zm-302.8-50L139.4 42 42 124.8l27.8 33 97.4-83zm99.5 97.8h-32V300L336 360.7l16-26.5-85.5-50V172.7zm-10.7-85c-107 0-192.6 86-192.6 191.2C63.4 384 149 470 256 470c106 0 192.6-86 192.6-191.2 0-105-86.7-191-192.6-191zm0 340c-82.4 0-149.8-67-149.8-148.8C106.2 197 173.6 130 256 130S405.8 197 405.8 279c0 83-67.4 148.7-149.8 148.7z" />
                    </svg>
                    {deadline}
                </div>
                ...
                <div className="Action__share-icons">
                    <a className="Action__share-icon Action__share-icon--fb">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="100 20 512 512">
                            <path
