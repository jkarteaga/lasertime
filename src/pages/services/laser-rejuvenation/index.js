    ...
    return (
        <div>
            ...
            <div className="PageContent__wrapper">
                ...
                <p>Это новейшая методика фракционного лазерного омоложения кожи, позволяющая сократить время восстановления кожи после процедуры ПО СРАВНЕНИЮ С ДРУГИМИ ЛАЗЕРНЫМИ МЕТОДИКАМИ. Компания DEKA разработала фракционный лазер SmartXide DOT 10600 нм. Эта лазерная системы признана «Золотым стандартом» для устранения эстетических проблем, вызванных процессами старения кожи.</p>
                ...
                <p>Энергия СО2 лазера создает узкие контролируемые колонки теплового повреждения (МТЗ), которые проникают в дерму, коагулируя ткани, и запускают процессы синтеза новых структур дермы: неоколлагеногенез, неоангиогенез, синтез гликозаминогликанов. Ткань между микротермальными зонами не затрагивается, в результате чего процесс регенерации клеток и восстановления кожного покрова проходит намного быстрее.</p>
                ...
                <InfoPanel title="Преимущества DOT технологии" color="green" shadow>
                    <List marker="plus">
                        <ul>
                            ...
                            <li>характеризуется коротким реабилитационным периодом</li>
                            <li>процедура дает стойкий и длительный результат</li>
                            <li>DOT технология «золотой стандарт» для решения проблем с пигментацией, атоничной кожей, морщинами, шрамами, рубцами от акне, растяжек и стрий</li>
                            <li>
                ...
                <InfoPanel title="Нормальные реакции кожи на INFINI®" color="green" shadow>
                    <List marker="check">
                        <ul>
                            <li>Эритема – является нормальной реакцией кожи после терапии с использованием аппарата DOT и обычно проходит за 6 дней . Эритему можно уменьшить с помощью использования регенеративных мазе, кремов и гелей после процедуры.</li>
                ...
                <InfoPanel title={'Памятка по послепроцедурному уходу за кожей'} color={'gray'} shadow>
                    <List>
                        <ol>
                            ...
                            <li>В течении 4 дней процедуры нельзя на обработанную область наносить макияж, бриться и принимать душ. Применение ранозаживляющего крема с антибиотиками утром и вечером(возможно применение гормонсодержащих кремов для снятия неспецифического воспаления) поможет сократить реабилитационный период и быстро избавить от отека и эритемы.</li>
