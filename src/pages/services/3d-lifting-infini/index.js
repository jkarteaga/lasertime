    ...
    return (
        <div>
            ...
            <div className="PageContent__wrapper">
                ...
                <p>Микроиглы толщиной 200мкм, имеющие золотое покрытие и силиконовую изоляцию до кончика иглы, проникают вовнутрь тканей на заданную глубину и воздействуют RF излучением в области кончиков игл. Такого рода воздействия усиливают регенерацию кожных структур: коллагена, эластина и дермального матрикса. RF терапия стимуляция синтеза нового коллагена, эластина и гиалуроновой кислоты, стимулирует процесс неоангиогенеза (образование новых сосудов).</p>
                <p>Аппарат Infini (США) - воздействует на глубинные слои кожи, но при этом мало травмирует эпидермис, но стимулирует и нормализует все метаболические процессы в нем.</p>
                ...
                <CollapsiblePanel title={'Преимущества'}>
                    <PullQuote />
                    ...
                    1. Быстрый реабилитационный период (2 дня) Восстановление оптических свойств кожи, разглаживание рельефа. Улучшение цвета лица, уменьшение глубины морщин Достижение видимых результатов через месяц (при условии прохождения процедуры не реже 1 раза в 2 недели. 2. Показано для тонкой морщинистой кожи, достигается эффект уплотнения кожи. 3. Другие методы фракционного омоложение проходят с реабилитацией до 7 дней.
                </CollapsiblePanel>
                ...
                <InfoPanel title={'Противопоказания к процедуре Infini®'} color={'red'} shadow>
                    <List marker={'cross'} title="Строгие противопоказания">
                        <ul>
                            <li>Острые воспалительные заболевания кожи (фолликуты, угревая болезнь, герпис)</li>
                ...
                <InfoPanel title={'Порядок процедуры'} shadow>
                    <List>
                        Одноразования индивидуальная насадка неможет использоваться повторно из-за высокой степени риска заражения любыми воспалительными заболеваниями.
                        <ol>
                ...
                <InfoPanel title="Побочные эффекты" color="green" shadow>
                    <List marker="check">
                        <ul>
                            Нормальные реакции кожи на INFINI®
                        ...
                        Негатив
                        <li>Гиперпигментация (наличие пигментных пятен на коже), вследствие неправильного постпроцедурного ухода</li>
                        <li>Появление точеных рубцов, вследсвие преждевременного отшелушевания пациентом корочек от микроповреждений</li>
                        <li>Воспаления, в следствии нарушении постпроцедурного ухода и правил личной гигиены</li>
                        <li>Образование гематом (синяков) при сокрытии факта приёма НПВС, аспирина, кардио-магнила, антикоагулянтов и антиагрегантов</li>
                    </List>
                </InfoPanel>
                ...
                <InfoPanel title={'Как подготовиться к процедуре'} shadow color={'gray'}>
                    <List>
                        <ol>
                            ...
                            <li>В течение друх недель до процедуры исключить любой загар.</li>
                ...
                <InfoPanel title={'Памятка по процедуре'} color={'gray'} shadow>
                    <List>
                        <ol>
                            ...
                            <li>Перед выходом на солце регулярно используйте крем с фотозащитными свойствами – SPF не менее 50. Не забывайте, когда кожа восстанавливается после любой процедуры она требует к себе более бережного отношения!</li>
                        </ol>
                    </List>
