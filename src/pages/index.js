    ...
    render() {
        return (
            <div className="PageContent__wrapper">
                ...
                <p>
                    Центр находится в самом центре Москвы – Рыбников переулок,
                    дом 4.
                </p>
                <p>
                    Специализация центра – anti-aging терапия, лазерная эпиляция
                    александритовым лазером, лазерное удаление сосудов и
                    сосудистых звездочек на лице и на теле, контурная пластика,
                    нитевой и плазмолифтинг, пилинги и уходы за кожей лица и
                    тела.
                </p>

                <p>
                    Инновационные методики омоложения в медицинском центре -
                    это:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        Контурная пластика – современный метод борьбы с
                        морщинами
                    </li>
                ...
                <p>
                    Медицинский центр «Знак качества» предлагает консультацию
                    врача и индивидуальный комплексный подход к каждому
                    пациенту, что выражается в индивидуальном подборе и
                    использовании комплекса процедур и препаратов, нацеленных на
                    решение конкретной проблемы. Наши врачи, устраняя имеющиеся
                    у пациента проблемы, используют наиболее щадящие,
                    безболезненные и эффективные методики, а также стремятся
                    задействовать превентивные меры для устранения проблем,
                    возникающих в будущем.
                </p>
                <p>
                    Вместе с демократичными ценами, акциями и скидками
                    постоянным клиентам наш медицинский центр обеспечивает
                    индивидуальный подход к каждому клиенту.
                </p>
                <p>
                    Эффективность работы медицинского центра «Знак качества»
                    определяется нацеленностью на результат, что в свою очередь
                    достигается тремя основополагающими принципами работы
                    центра:
                </p>
                <ul>
                    <li>
                        подход к пациенту и его проблемам, предполагающий
                        индивидуальное и комплексное использование доказавших
                        свою эффективность методик;
                    </li>
                    <li>
                ...
                <p>
                    ...
                    решению конкретной проблемы. Так, использование
                    ботулинотерапии не обеспечивает молодость, ухоженный вид и
                    резкий anti-aging эффект, однако вместе с другими
                    аппаратными и инъекционными методиками обеспечивает решение
                    многих проблем.
                </p>
                <p>
