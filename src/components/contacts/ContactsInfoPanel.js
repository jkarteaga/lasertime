    ...
    return (
        <div className="ContactsInfoPanel">
            <div className="ContactsInfoPanel__item">
                <div className="ContactsInfoPanel__icon ContactsInfoPanel__icon--phone">
                    Phone
                </div>
            ...
            <div className="ContactsInfoPanel__item">
                <div className="ContactsInfoPanel__icon ContactsInfoPanel__icon--address">
                    Address
                </div>
            ...
            <div className="ContactsInfoPanel__item">
                <div className="ContactsInfoPanel__icon ContactsInfoPanel__icon--email">
                    Email
                </div>
