    ...
    return (
        <div className="Action">
            ...
            <div className="Action__body">
                <div
                    className={`Action__badge Action__badge--${badgeColor}`}
                >{`-${discount}%`}</div>
                <div className="Action__description">{descriptionElement}</div>

                <div className="Action__price">
                    <div className="Action__price Action__price--old">
                        {priceOld} руб.
                    </div>
                    <div className="Action__price Action__price--new">
                        {priceNew} руб.
                    </div>
                </div>

                <div
                    className={`Action__deadline Action__deadline--${deadlineColor}`}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="-20 -20 290 290"
                    >
                        <path d="M135 57H114V142l67.5 40.6L192 165l-57-33.4V57zm-7-57C57 0 0 57.6 0 128s57 128 128 128c70.4 0 128-57.6 128-128S198.4 0 128 0zm0 227.6c-54.8 0-99.6-44.8-99.6-99.6S73.2 28.4 128 28.4s99.6 44.8 99.6 99.6c0 55.5-44.8 99.6-99.6 99.6z" />
                    </svg>
                    {deadline}
                </div>
